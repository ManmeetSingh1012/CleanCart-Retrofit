...
/** display the data according to the category choosen**/
@Composable
fun category_screen(it: Product, navHostController: NavHostController, context: MainActivity)
{
    ...
    Card(modifier = Modifier.height(height = 250.dp)
            ...
            verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.CenterHorizontally)
        {
            ...
            Row(modifier = Modifier
                .fillMaxWidth()
                .padding(start = 5.dp, end = 5.dp), horizontalArrangement = Arrangement.SpaceBetween)
            {
                Text(
                    text = "$${it.price}",
                    fontSize = 16.sp,
            ...
            Row(modifier = Modifier.fillMaxWidth() , horizontalArrangement = Arrangement.Center) {
                ...
                repeat(count){
                    ...
                    Image(painter = painterResource(id = R.drawable.star), contentDescription = "start" , modifier = Modifier.padding(3.dp))
                }
